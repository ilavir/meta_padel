...
def index():
    ...
    is_season_filter = season in ['autumn_2025', 'winter_2025', 'spring_2026', 'summer_2026']
...
def update_rankings():
    ...
    valid_types = ['male', 'female', 'all', 'autumn_2025', 'winter_2025', 'spring_2026', 'summer_2026']
    ...
    if rank_type and rank_type not in valid_types:
        ...
        elif rank_type == 'summer_2026':
            return redirect(url_for('rating.index', season='summer_2026'))
        elif rank_type in ['male', 'female']:
            return redirect(url_for('rating.index', gender=rank_type))
    else:
        # Update all rankings
        for rt in ['all', 'male', 'female', 'autumn_2025', 'winter_2025', 'spring_2026', 'summer_2026']:
